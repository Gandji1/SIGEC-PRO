...
const TenantConfigurationPage = lazy(() =>
  import("./pages/TenantConfigurationPage")
);
const PaymentConfigurationPage = lazy(() =>
  import("./pages/PaymentConfigurationPage")
);
...
const ApprovisionnementPage = lazy(() =>
  import("./pages/ApprovisionnementPage")
);
...
const SuperAdminAccountingPage = lazy(() =>
  import("./pages/SuperAdminAccountingPage")
);
...
const EnrichedInventoryPage = lazy(() =>
  import("./pages/EnrichedInventoryPage")
);
...
const RapprochementBancairePage = lazy(() =>
  import("./pages/RapprochementBancairePage")
);
      ...
      <Router>
        <Suspense fallback={<Loader message="Chargement de la page..." />}>
          <Routes>
            ...
            {/* Payment Callback - nécessite authentification mais pas d'abonnement */}
            <Route
            ...
            <Route
              path="/platform"
              element={
                <PrivateRoute skipSubscriptionCheck>
                  <SuperAdminDashboard />
                </PrivateRoute>
              }
            />
            ...
            {/* Inventaire Enrichi */}
            <Route
              path="/inventory-enriched"
              element={
                <PrivateRoute>
                  <EnrichedInventoryPage />
                </PrivateRoute>
              }
            />
