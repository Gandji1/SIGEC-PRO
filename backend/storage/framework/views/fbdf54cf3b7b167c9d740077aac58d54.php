    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="alert-box">
                ...
                <div>La commande <strong>#<?php echo e($reference); ?></strong> de <strong><?php echo e($supplier_name); ?></strong> a été livrée.</div>
                <div style="margin-top: 10px; font-size: 20px; font-weight: bold;"><?php echo e($total); ?></div>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="value"><?php echo e($delivered_at); ?></span>
                </div>
            </div>
            
            <div style="text-align: center;">
                <a href="<?php echo e($direct_link); ?>" class="btn">Réceptionner maintenant →</a>
            </div>
...
<?php /**PATH C:\Users\GSA\Desktop\APPLICATION WEB\SIGEC-main\backend\resources\views/emails/tenant/tenant_order_delivered.blade.php ENDPATH**/ ?>