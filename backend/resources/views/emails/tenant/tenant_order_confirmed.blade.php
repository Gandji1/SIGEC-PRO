    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="success-box">
                <div><strong>{{ $supplier_name }}</strong> a confirmé la commande <strong>#{{ $reference }}</strong></div>
                <div style="margin-top: 10px; font-size: 20px; font-weight: bold; color: #059669;">{{ $total }}</div>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="value">{{ $confirmed_at }}</span>
                </div>
            </div>
